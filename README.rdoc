...
To test using an old version of activesupport, use the corresponding gemfile:

```
BUNDLE_GEMFILE=gemfiles/active_support_4.gemfile bundle install
BUNDLE_GEMFILE=gemfiles/active_support_4.gemfile bundle exec rake test
```

or

```
BUNDLE_GEMFILE=gemfiles/active_support_3.gemfile bundle install
BUNDLE_GEMFILE=gemfiles/active_support_3.gemfile bundle exec rake test
```
